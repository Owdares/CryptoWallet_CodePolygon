...
namespace Blaved.Controllers.Bot.RequestHandler
{
    public class CallbackRequestHandler
    {
        ...
        private async Task WalletPutPage_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            await _botMenu.Wallet.Wallet(user, cancellationToken, pageNum);
        }
        ...
        private async Task BonusBalancePutPage_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            await _botMenu.Wallet.BonusBalance(user, cancellationToken, pageNum);
        }
        ...
        private async Task BonusBalanceToBalance_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            if(result)
            {
                ...
                await _botMenu.Wallet.BonusBalance(user, cancellationToken);
            }
            else
            {
        ...
        private async Task DepositWaitNetwork_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            if (!_appConfig.FunctionConfiguration.AssetEnable.Deposit[Asset])
            {
                await _botMenu.Main.AssetDisabledAnswer(user, callbackQuery.Id, cancellationToken);
                return;
            }
            ...
            await _botMenu.Wallet.DepositWaitNetwork(user, Asset, cancellationToken);
        }
        ...
        private async Task DepositeViewAddressPutAssetNetwork_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            await _botMenu.Wallet.DepositViewAddress(user, Asset, network, cancellationToken);
        }
        ...
        private async Task DepositWaitAssetPutPage_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            await _botMenu.Wallet.DepositWaitAsset(user, cancellationToken, num);
        }
        ...
        private async Task WithdrawCreateWaitNetworkPutAsset_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            if (!_appConfig.FunctionConfiguration.AssetEnable.Withdraw[Asset])
            {
                await _botMenu.Main.AssetDisabledAnswer(user, callbackQuery.Id, cancellationToken);
                return;
            }
            ...
            await _botMenu.Wallet.WithdrawCreateWaitNetwork(user, Asset, cancellationToken);
        }
        ...
        private async Task WithdrawCreateWaitAddressPutAssetNetwork_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            var infoForWithdraw = await _infoService.GetInfoForWithdraw(Asset, network);

            if (ValidateData.ValidateWithdrawCreate_Balance(user, infoForWithdraw))
            {
                ...
                await _botMenu.Wallet.WithdrawCreateWaitAddress(user, Asset, network, cancellationToken);
            }
            else
            {
                await _botMenu.Wallet.WithdrawCreateInsufficientBalanceAnswer(user, infoForWithdraw, callbackQuery.Id, cancellationToken);
            }
        ...
        {
            if (!_appConfig.FunctionConfiguration.AssetEnable.Withdraw[user.MessagesWithdrawModel.Asset])
            {
                await _botMenu.Main.AssetDisabledAnswer(user, callbackQuery.Id, cancellationToken);
                return;
            }
            if (!_appConfig.FunctionConfiguration.NetworkEnable.Withdraw[user.MessagesWithdrawModel.Network])
            {
                await _botMenu.Main.NetworkDisabledAnswer(user, callbackQuery.Id, cancellationToken);
                return;
            }
            ...
            await _botMenu.Wallet.WithdrawCreateWaitAmount(user, cancellationToken);
        }
        ...
        private async Task WithdrawCreatePutAmount_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            var infoFroWithdraw = await _infoService.GetInfoForWithdraw(user.MessagesWithdrawModel.Asset, user.MessagesWithdrawModel.Network);
            ...
            if (ValidateData.ValidateWithdrawCreate_Amount(user, amount, infoFroWithdraw))
            {
                ...
                await _botMenu.Wallet.WithdrawConfirm(user, cancellationToken);
            }
            else
            {
        ...
        private async Task WithdrawConfirm_ProcessorAsync(UserModel user, CallbackQuery callbackQuery, CancellationToken cancellationToken)
        {
            ...
            var infoForWithdraw = await _infoService.GetInfoForWithdraw(user.MessagesWithdrawModel.Asset, user.MessagesWithdrawModel.Network);
            ...
            if (ValidateData.ValidateWithdrawCreate_Amount(user, user.MessagesWithdrawModel.Amount, infoForWithdraw))
            {
                ...
                await _botMenu.Wallet.Wallet(user, cancellationToken);
            }
            else
            {
